...
if(isset($_GET['prec'])){$prec=$_GET['prec'];}else{$prec=3;}
?>
...
function generateChartData() {
    ...
    // and generate 500 data items
                    <?php
$r_hist=mysqli_query($wikeo,"SELECT moment,valeur FROM historique_btc order by moment");
   ...
   <?php 
    ...
    <body>
     <div  class="etiquettes" style='width:250px;position:relative;align:center;float:right'>
       <form name="form1" method="get" action="amchartbtc.php">
    ...
    <div  class="etiquettes" style='width:300px;position:relative;align:center;'><span>
       
        Evolution du cours du Bitcoin </span></div>
